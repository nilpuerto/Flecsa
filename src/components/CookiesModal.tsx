  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Uso de cookies por parte de Flecsa</DialogTitle>
        ...
        <div className="space-y-6 text-slate-700">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">Cómo gestionar las cookies</h3>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-3">Categorías de cookies</h3>
            ...
            <div className="space-y-4">
              <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                <h4 className="font-semibold text-slate-900 mb-2">Categoría 1: cookies estrictamente necesarias</h4>
                <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                <h4 className="font-semibold text-slate-900 mb-2">Categoría 2: cookies sobre comportamiento</h4>
                <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                <h4 className="font-semibold text-slate-900 mb-2">Categoría 3: cookies de funcionalidad</h4>
                <p className="text-sm text-slate-600 leading-relaxed">
